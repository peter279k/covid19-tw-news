...
import AgstableDailyCov19 from "@/components/AgstableDailyCov19.vue";
...
const routes = [
  ...
  { path: "/agstableDailyCov19", name: "AgstableDailyCov19", component: AgstableDailyCov19, props: true, },
];
